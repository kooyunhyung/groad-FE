...
class TravelCourse2 extends StatefulWidget {
  const TravelCourse2({Key key}) : super(key: key);

  @override
  State<TravelCourse2> createState() => _TravelCourse2State();
}

class _TravelCourse2State extends State<TravelCourse2> {
  int flag;
  ...
  CameraPosition _cameraPosition =
      CameraPosition(target: LatLng(37.8659222, 127.6984547), zoom: 11.7);
  ...
  build(BuildContext context) {
    ...
    Marker marker1 = Marker(
      markerId: 'Uiamho Skywalk',
      position: LatLng(37.8468056, 127.6801772),
      captionText: "춘천 의암호\n스카이워크",
    ...
    Marker marker2 = Marker(
      markerId: 'King Canoe Ferry',
      position: LatLng(37.8557222, 127.6854547),
      captionText: "킹카누\n나루터",
    ...
    Marker marker3 = Marker(
        markerId: 'Samaksan Lake Cable Car',
        position: LatLng(37.8644008, 127.6913653),
        captionText: "춘천삼악산\n호수케이블카\n의암호정차장",
        captionOffset: 10,
    ...
    Marker marker4 = Marker(
        markerId: 'Sangsang Madang',
        position: LatLng(37.8741327, 127.7023584),
        captionText: "KT&G\n상상마당\n춘천\n아트센터",
    ...
    Marker marker5 = Marker(
        markerId: 'Legoland Korea Resort',
        position: LatLng(37.8839056, 127.6969079),
        captionText: "레고랜드\n코리아\n리조트",
        ...
        Row(
          ...
          children: [
            Text(
              "춘천 의암호\n스카이워크",
              style:
                  TextStyle(color: Color(ThemeColors.deepNavy), fontSize: 12.0),
            ),
            Text(
              "킹카누\n나루터",
              style:
  ...
  Future<List<LatLng>> _fetchLatLng() async {
    response = await UserAPI(context: context).getPath2_();

    final pathOverlayId = PathOverlayId("course2");
    ...
    _pathOverlays.add(PathOverlay(pathOverlayId, path_prepared,
        width: 3,
        outlineWidth: 2,
        color: Color(ThemeColors.deepNavy),
        outlineColor: Color(ThemeColors.deepNavy)));

...
class _TravelCourse2State extends State<TravelCourse2> {
  ...
  CameraPosition(target: LatLng(37.8619222, 127.6984547), zoom: 12.2);
  ...
  build(BuildContext context) {
    ...
    List<LatLng> path = [
      LatLng(37.8468056, 127.6801772),
      LatLng(37.8468056, 127.6801772),
      LatLng(37.8557222, 127.6854547),
      LatLng(37.8644008, 127.6913653),
      LatLng(37.8741327, 127.7023584),
      LatLng(37.8839056, 127.6969079)
    ];

...
import 'Confucianism_Info.dart';

class ConfucianismPage extends StatefulWidget {
  const ConfucianismPage({Key? key}) : super(key: key);

  @override
  _ConfucianismPageState createState() => _ConfucianismPageState();
}

class _ConfucianismPageState extends State<ConfucianismPage> {
  var _selectedIndex = 2; //페이지 인덱스 0,1
  var _pages = [
    Schedule(), //하단 0번 인덱스
    Benefits(), //하단 1번 인덱스
    Confucianism_InfoPage(), //하단 2번 인덱스(default)
    Feed(), //하단 3번 인덱스
    MyPage(), //하단 4번 인덱스
  ];

...
import 'Confucianism_DetailPage1.dart';

class Confucianism_DetailPage extends StatefulWidget {
  const Confucianism_DetailPage({Key? key}) : super(key: key);

  @override
  _Confucianism_DetailPageState createState() => _Confucianism_DetailPageState();
}

class _Confucianism_DetailPageState extends State<Confucianism_DetailPage> {
  var _selectedIndex = 2; //페이지 인덱스 0,1
  var _pages = [
    Schedule(), //하단 0번 인덱스
    Benefits(), //하단 1번 인덱스
    Confucianism_DetailPage1(), //하단 2번 인덱스(default)
    Feed(), //하단 3번 인덱스
    MyPage(), //하단 4번 인덱스
  ];

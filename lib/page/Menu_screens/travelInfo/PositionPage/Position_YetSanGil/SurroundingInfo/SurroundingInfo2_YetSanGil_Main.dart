...
import 'SurroundingInfo2_YetSanGil.dart';

class SurroundingInfo2_YetSanGil_Main extends StatefulWidget {
  const SurroundingInfo2_YetSanGil_Main({Key? key}) : super(key: key);

  @override
  _SurroundingInfo2_YetSanGil_MainState createState() => _SurroundingInfo2_YetSanGil_MainState();
}

class _SurroundingInfo2_YetSanGil_MainState extends State<SurroundingInfo2_YetSanGil_Main> {
  var _selectedIndex = 2; //페이지 인덱스 0,1
  var _pages = [
    Schedule(), //하단 0번 인덱스
    Benefits(), //하단 1번 인덱스
    SurroundingInfo2_YetSanGil(), //하단 2번 인덱스(default)
    Feed(), //하단 3번 인덱스
    MyPage(), //하단 4번 인덱스
  ];

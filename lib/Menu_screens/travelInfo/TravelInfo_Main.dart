...
class TravelInfo_Main extends StatefulWidget {
  const TravelInfo_Main({Key? key}) : super(key: key);

  @override
  _TravelInfo_MainState createState() => _TravelInfo_MainState();
}

class _TravelInfo_MainState extends State<TravelInfo_Main> {
  var _selectedIndex = 2; //페이지 인덱스 0,1
  var _pages = [
    Schedule(), //하단 0번 인덱스
    Benefits(), //하단 1번 인덱스
    TravelInfo(), //하단 2번 인덱스(default)
    Feed(), //하단 3번 인덱스
    MyPage(), //하단 4번 인덱스
  ];

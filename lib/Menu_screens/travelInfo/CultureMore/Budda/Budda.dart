...
import 'BuddaInfo.dart';

class BuddaPage extends StatefulWidget {
  const BuddaPage({Key? key}) : super(key: key);

  @override
  _BuddaPageState createState() => _BuddaPageState();
}

class _BuddaPageState extends State<BuddaPage> {
  var _selectedIndex = 2; //페이지 인덱스 0,1
  var _pages = [
    Schedule(), //하단 0번 인덱스
    Benefits(), //하단 1번 인덱스
    BuddaInfoPage(), //하단 2번 인덱스(default)
    Feed(), //하단 3번 인덱스
    MyPage(), //하단 4번 인덱스
  ];
  @override
